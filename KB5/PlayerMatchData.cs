...
public class PlayerMatchDataContainer
{
    ...
    public static void AddPlayer(string player_id, string player_name)
    {
        _players.TryAdd(player_id, new(player_id, player_name));
    }

    public void AddPlayerWithName(string player_id, string player_name)
    {
        _players.TryAdd(player_id, new(player_id, player_name));
    }
...
public class PlayerMatchData
{
    ...
    public PlayerOnceData CurrentData;

    [JsonProperty("matches_data")]
    public List<PlayerOnceData> data;
